...
package io.sunshine0523.freeform.shortcut;

import static io.sunshine0523.freeform.shortcut.ShortcutConstants.LOGGER;
import static io.sunshine0523.freeform.shortcut.ShortcutConstants.SHORTCUT_EXTRA;
import static io.sunshine0523.freeform.shortcut.ShortcutConstants.SHORTCUT_ID;
...
public class SuiShortcut {
    ...
    private static ShortcutInfo createShortcut(Context context, Resources resources) {
        ...
        try {
            ...
            int id = resources.getIdentifier("ic_setting", "drawable", "com.sunshine.freeform");
            if (id == 0) {
        ...
        return new ShortcutInfo.Builder(context, SHORTCUT_ID)
                .setShortLabel("Mi-Freeform")
                .setLongLabel("Mi-Freeform")
                .setIcon(icon)
