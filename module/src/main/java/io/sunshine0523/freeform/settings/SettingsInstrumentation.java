...
import static io.sunshine0523.freeform.shortcut.ShortcutConstants.SHORTCUT_EXTRA;
...
import io.sunshine0523.freeform.resource.MiFreeformApk;
import io.sunshine0523.freeform.utils.InstrumentationUtil;
...
public class SettingsInstrumentation extends Instrumentation {
    ...
    public SettingsInstrumentation(Instrumentation original, MiFreeformApk miFreeformApk) {
        this.original = original;

        application = ActivityThread.currentActivityThread().getApplication();
        classLoader = miFreeformApk.getClassLoader();
        suiActivityClass = miFreeformApk.getSuiActivityClass();
        suiActivityConstructor = miFreeformApk.getSuiActivityConstructor();
        resources = miFreeformApk.getResources();
    ...
    public Activity newActivity(ClassLoader cl, String className, Intent intent) throws ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        if (extras != null) {
            ...
            if (extras.getInt(SHORTCUT_EXTRA, -1) != -1) {
                LOGGER.v("creating MiFreeformActivity");
                try {
