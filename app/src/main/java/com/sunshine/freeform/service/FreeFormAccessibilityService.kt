...
//        println("freeForm $newConfig")
//        val newOrientation = resources.configuration.orientation
//        if (FloatingService.orientationChangeListener != null && orientation != newOrientation) {
//            FreeFormConfig.orientation = newOrientation
//            FloatingService.orientation = newOrientation
