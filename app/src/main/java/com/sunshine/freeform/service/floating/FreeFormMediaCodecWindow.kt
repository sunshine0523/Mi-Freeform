...
// */
//class FreeFormMediaCodecWindow(
...
//
//    private val MIME_TYPE = "video/hevc"    //h265
//    private val FRAME_RATE = 60             //fps
//    private val IFRAME_INTERVAL = 0         //关键帧间隔0s
//
////    //主界面
////    private var textureView: TextureView? = null
//
...
//            format.setInteger(MediaFormat.KEY_BIT_RATE, WIDTH * HEIGHT * FRAME_RATE)
...
//            freeFormLayout = LayoutInflater.from(service).inflate(R.layout.view_freeform_textureview, null, false)
//
//            //获取主界面布局，其实布局完全相同，只是为了减少控制时的if判断
//            val mainId = if (FreeFormConfig.controlModel == 1) R.id.textureView_root else R.id.textureView_xposed
//
//            swingView = freeFormLayout!!.findViewById(R.id.view_swing)
//            textureView = freeFormLayout!!.findViewById(mainId)
...
//
//            swingView!!.setOnTouchListener(TouchListener(textureView!!))
//            textureView!!.setOnTouchListener(TouchListener(textureView!!))
//            closeView!!.setOnTouchListener(TouchListener(textureView!!))
//            //点击为模拟返回
